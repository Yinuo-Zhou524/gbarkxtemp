...
latempspring_regs2A<-data.frame(matrix(nrow=0,ncol=8,data=NA))
names(latempspring_regs2A)<-c("segment","int","slope","R2","D","D_sd","Tc","Tc_sd")
...
#for each stem, calculate water loss rate with an lm and put coeffients in a table
latempspring_regs2B<-data.frame(matrix(nrow=0,ncol=8,data=NA))
names(latempspring_regs2B)<-c("segment","int","slope","R2","D","D_sd","Tc","Tc_sd")
...
#for each stem, calculate water loss rate with an lm and put coeffients in a table
latempspring_regs2C<-data.frame(matrix(nrow=0,ncol=8,data=NA))
names(latempspring_regs2C)<-c("segment","int","slope","R2","D","D_sd","Tc","Tc_sd")
...
#for each stem, calculate water loss rate with an lm and put coeffients in a table
latempspring_regs2D<-data.frame(matrix(nrow=0,ncol=8,data=NA))
names(latempspring_regs2D)<-c("segment","int","slope","R2","D","D_sd","Tc","Tc_sd")
...
#for each stem, calculate water loss rate with an lm and put coeffients in a table
latempspring_regs2E<-data.frame(matrix(nrow=0,ncol=8,data=NA))
names(latempspring_regs2E)<-c("segment","int","slope","R2","D","D_sd","Tc","Tc_sd")
...
latempspring_gs$gs<-latempspring_gs$E/latempspring_gs$D #mmol/s/m2

#calculate bark thickness ratio
latempspring_gs$bark_thickness_ratio<-latempspring_gs$bark_thickness/latempspring_gs$diam
write.csv(latempspring_gs,"gbark_temp_Goff_1957_spring1.csv")
####look at R2  
par(mfrow=c(1,1))
